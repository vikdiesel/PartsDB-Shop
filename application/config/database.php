...
$db['local_db']['username'] = '';
$db['local_db']['password'] = '';
$db['local_db']['database'] = 'devdb_partsdbshop';

/* Probably, you ain't gonna need to change that */
$db['local_db']['dbdriver'] = 'mysql';
$db['local_db']['dbprefix'] = '';
$db['local_db']['pconnect'] = TRUE;
$db['local_db']['db_debug'] = FALSE;
